data atussum_2017;
length TUCASEID $14;
infile 'c:\atussum_2017.dat' lrecl=8192 dlm=',' missover dsd firstobs=2;
input
TUCASEID
TUFINLWGT
TRYHHCHILD
...
label t110299 = "Waiting associated with eating and drinking, n.e.c.*";
...
label t180399 = "Travel rel. to caring for and helping hh members, n.e.c.*";
...
;
run;
proc contents data=atussum_2017; run;
